        ...
        <>
          <div className="cakes_page_container">
            <div className="filter_container">
              <button className="filter_button"># 돔형</button>
              <button className="filter_button"># 초승달형</button>
              <button className="filter_button"># 반달형</button>
            </div>

            <div className="images_container">
              {console.log("riceProductsData", riceProductsData)}
